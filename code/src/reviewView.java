...
public class reviewView extends JPanel {
    ...
    private JPanel mainContentPanel; // Main content panel for switching views
        ...
        private void showBrandReview (String brandName, Font oswald)
        {
            ...
            if (brandName.equals("Abercrombie & Fitch"))
            {
                ...
                for (int i = 0; i < rating; i++) {
                    ImageIcon filledStar = new ImageIcon(Objects.requireNonNull(getClass().getResource("pictures/filledStar.png")));
                    Image scaledStar = filledStar.getImage().getScaledInstance(50, 50, Image.SCALE_SMOOTH);
                ...
                for (int i = rating; i < 5; i++) {
                    ...
                    Image scaledStar = emptyStar.getImage().getScaledInstance(50, 50, Image.SCALE_SMOOTH);
                    JLabel starLabel = new JLabel(new ImageIcon(scaledStar));
                    starLabel.setBounds(startX, 550, 50, 50);
                    mainContentPanel.add(starLabel);
                    startX += 60;
